...
axs[0].plot(
    lissajous.x(t, s), lissajous.z(t, s), label="$\kappa_e = 1$", color=colors[1]
)
lissajous.kappa = 0
axs[0].plot(
    lissajous.x(t, s), lissajous.z(t, s), label="$\kappa_e = 0$", color=colors[2]
)
...
for a, b in zip(az, beta):
    ...
    axs[1].plot(pos[0], pos[1], linestyle="--", color=colors[0])
axs[1].plot(
    lissajous.x(t, s), lissajous.y(t, s), label="$\kappa_e = 1$", color=colors[1]
)
lissajous.kappa = 0
axs[1].plot(
    lissajous.x(t, s), lissajous.y(t, s), label="$\kappa_e = 0$", color=colors[2]
)
axs[1].set_xlabel("x (m)")
axs[1].set_ylabel("y (m)")
axs[1].text(165, 2, r"$\phi_p$", ha="center", va="bottom")
