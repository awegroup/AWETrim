...
polars_path = (
    r"c:\Users\ocayon\Repositories\quasi-steady-awes\data\LEI-V3-KITE\polars.csv"
)
...
with open(
    r"c:\Users\ocayon\Repositories\quasi-steady-awes\data\LEI-V3-KITE\v3_aero_input.json",
    "r",
) as f:
    aero1 = json.load(f)
...
with open(
    r"c:\Users\ocayon\Repositories\quasi-steady-awes\data\LEI-V3-KITE\v3_VSM_aero_input.json",
    "r",
) as f:
    aero2 = json.load(f)
...
plt.plot(CD_exp, CL_exp, "o", label="VSM", color=colors[0])
plt.plot(CD2, CL2, "--", label="Fit VSM", color=colors[1])
plt.plot(CD1, CL1, "-", label="Corrected Powered", color=colors[2])
plt.plot(
    CD1_depowered, CL1_depowered, "-.", label="Corrected Depowered", color=colors[3]
)
plt.plot(CD1_steered, CL1_steered, ":", label="Corrected Steered", color=colors[5])
