...
class FlexibleLinkTether(Tether):
    ...
    @property
    def tension_kite(self):
        return ca.fmax(0,self.E * self.area_tether / self.length_tether * (self.distance_radial - self.length_tether))
...
class FlexibleLumpedTether(Tether):
    ...
    @property
    def tension_tether_ground(self):
        return self.tension_kite -self.drag_tether_at_kite[2] - self.force_gravity_tether_at_kite[2]
